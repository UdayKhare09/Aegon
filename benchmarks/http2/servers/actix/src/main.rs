...
async fn main() -> std::io::Result<()> {
    ...
    builder.set_private_key_file("benchmarks/http2/certs/server.key", openssl::ssl::SslFiletype::PEM)
        .expect("Failed to set private key");
    builder.set_certificate_chain_file("benchmarks/http2/certs/server.crt")

...
pub fn main(init: std.process.Init) !void {
    ...
    cfg.tls.cert_path = "benchmarks/http3/certs/server.crt";
    cfg.tls.key_path = "benchmarks/http3/certs/server.key";
    cfg.quic.enabled = true;
    cfg.quic.port = port;
    cfg.quic.cert_path = "benchmarks/http3/certs/server.crt";
    cfg.quic.key_path = "benchmarks/http3/certs/server.key";
    try cfg.validate();

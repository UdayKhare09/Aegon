...
features:
  ...
  - icon: 💾
    title: Integrated Query & Entity Caching
    details: Transparent write-through/look-aside caching with transaction-aware invalidations, partition epoch tags, and local memory tiers.
  - icon: 🌐
    title: Enterprise HTTP Subsystem
    details: High-throughput HTTP routing, RFC 7807 Problem Details error handling, type-safe payload binding, and zero-copy static file streaming.
---
